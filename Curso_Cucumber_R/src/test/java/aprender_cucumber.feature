...
Funcionalidade: 
  ...
  Cenário: Deve incrementar contador
    ...
    Então o valor do contador será 19

  Cenário: Deve incrementar contador
    Dado que o valor do contador é 123
    Quando eu incrementar em 3
    Então o valor do contador será 126

  Cenário: Deve cacular atraso no prazo de entrega
    Dado que o prazo é dia 05/04/2018
    Quando a entrega atrasa em 2 dias
    Então a entrega será efetuada e 07/04/2018

  Cenário: Deve cacular atraso no prazo de entrega
    Dado que o prazo é dia 05/04/2018
    Quando a entrega atrasa em 2 meses
    Então a entrega será efetuada e 07/05/2018
